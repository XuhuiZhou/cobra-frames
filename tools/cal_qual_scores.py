...
def score_rule(i,j,v):
    if v in ['Answer.powerDiffRating1', 'Answer.powerDiffRating2', 'Answer.powerDiffRating3']:
...
scores, workers = calculate_scores(worker_ratings, ratings_reference, ratings_var)
