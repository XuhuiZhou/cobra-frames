...
if [[ $EXP == "train_xxl" ]]; then
    ...
    python sbf_modeling/train.py --gin_file="scripts/explain_model/explain_model.gin" --gin_file="exp/configs/train_explain_model_l_2_epoch.gin" --gin.MODEL_DIR="'.log/explain-model-l'" --gin.MODE="'deployment'"
else
