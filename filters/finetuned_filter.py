...
dataset = load_dataset(
    "csv",
    data_files={
        "train": "./data/filters/train.csv",
        "validation": "./data/filters/valid.csv",
    },
)
...
breakpoint()
model = T5ForPromptTuningQuesionAnswering.from_pretrained(
    "/home/xuhuiz/t5x-frozen-lm-qa-base", from_flax=True
)
metric = load_metric("accuracy")

training_args = TrainingArguments(
    output_dir=f"/projects/tir3/users/xuhuiz/socialiq/test_trainer_frozen_lm_qa",
