...
instructions = "Provide the social context in which a statement was probably said.\n\n"
...
def main(args):
  ...
  fPosts = posts[args.text_col].apply(formatPosts,preamble=instructions+formattedExamples)
